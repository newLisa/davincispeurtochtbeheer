        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <h2>Quest Aanpassen ({{$quest['quest']->naam}})</h2>

                    {{ Form::open(array('url' => 'quests/post')) }}
                        <div class="form-group">
                            {!! Form::label('Quest Naam') !!}
                            {!! Form::text('name', $quest['quest']->naam, 
                                            array('required', 
                                            'class'=>'form-control', 
                                            'id'=>'questName',
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('info', $quest['quest']->informatie, 
                                array('required', 
                                      'class'=>'form-control', 
                                      'id'=>'questInfo',
        ...
        function placePoly(polyJsonData) {
            for (var i = polyJsonData.length - 1; i >= 0; i--) {
                ...
                ({
                    position: newLocation,
                    map: map,
                    icon: 'http://www.googlemapsmarkers.com/v1/p' + polyJsonData[i].orderNumber + '/0099FF/'
                });
                polyMarkerId++;
        ...
        function placeMarkers(markersData) {
            for (var i = markersData.length - 1; i >= 0; i--) {
                ...
                var questions = 
                {
                    ...
                    answer3: markersData[i]['question']['answer_3'], 
                    answer4: markersData[i]['question']['answer_4'], 
                ...
                newMarker.metadata = 
                {
                    ...
                    isQR: markersData[i]['is_qr'], 
                    isVisible: markersData[i]['is_visible'], 
                    questions: questions
                };
